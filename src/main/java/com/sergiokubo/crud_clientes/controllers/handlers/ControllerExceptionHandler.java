package com.sergiokubo.crud_clientes.controllers.handlers;

import com.sergiokubo.crud_clientes.dto.CustomError;
import com.sergiokubo.crud_clientes.dto.ValidationError;
import com.sergiokubo.crud_clientes.services.exceptions.DatabaseException;
import com.sergiokubo.crud_clientes.services.exceptions.MethodArgumentNotValidException;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<CustomError> methodArgumentNotValidation(MethodArgumentNotValidException e, HttpServletRequest request){
        ...
        err.addError("income", "Renda inválida");
        return ResponseEntity.status(status).body(err);
    }
}
